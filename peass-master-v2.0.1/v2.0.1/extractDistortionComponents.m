...
destDir = cellstr(options.destDir);
srcFiles = cellstr(srcFiles);
J = length(srcFiles);
...
audiowrite(strcat(outputFilenames{1,1}{:}),trueSynth,fs);
audiowrite(strcat(outputFilenames{2,1}{:}),targetSynth,fs);
audiowrite(strcat(outputFilenames{3,1}{:}),interfSynth,fs);
audiowrite(strcat(outputFilenames{4,1}{:}),artifSynth,fs);
