...
[sTrue, fs] = audioread(strcat(decompositionFilenames{1}{:}));
eTarget = audioread(strcat(decompositionFilenames{2}{:}));
eInterf = audioread(strcat(decompositionFilenames{3}{:}));
eArtif = audioread(strcat(decompositionFilenames{4}{:}));
