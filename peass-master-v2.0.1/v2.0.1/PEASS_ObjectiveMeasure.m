function res = PEASS_ObjectiveMeasure(...
    originalFiles,estimateFile,varargin)
% Main function
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if nargin>2
    res.decompositionFilenames = extractDistortionComponents(originalFiles,estimateFile,varargin);
else
    res.decompositionFilenames = extractDistortionComponents(originalFiles,estimateFile);
end
